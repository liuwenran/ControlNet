...
second_model.load_state_dict(load_state_dict('./models/control_any3_normal.pth', location='cuda'))
...
save_folder = 'results/anythingv3_zhou_woyangni_canny_normal'
if not os.path.exists(save_folder):
   os.makedirs(save_folder)

frame_file = '/nvme/liuwenran/datasets/zhou_woyangni_frames/frames.txt'
